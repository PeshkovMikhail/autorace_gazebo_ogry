...
from autorace_communication_gazebo_ogry.action import Parking

class ParkingMission(Node):
    def __init__(self):
        super().__init__('parking_action_server')
        self.action_server = ActionServer(self, Parking, "parking", self.execute_callback)
...
def main(args=None):
    ...
    parking_action_server = ParkingMission()
